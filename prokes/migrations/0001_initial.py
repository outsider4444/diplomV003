# Generated by Django 3.1.3 on 2021-02-23 10:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_goods', models.ManyToManyField(to='prokes.Goods', verbose_name='Код изделия')),
                ('customer_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prokes.customers', verbose_name='Имя заказчика')),
            ],
        ),
    ]

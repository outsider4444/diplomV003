# Generated by Django 3.1.3 on 2021-03-03 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_goods', models.TextField(verbose_name='Изделия')),
                ('order_goods_values', models.TextField(verbose_name='Количество изделий')),
                ('code_goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prokes.goods', verbose_name='Код изделия')),

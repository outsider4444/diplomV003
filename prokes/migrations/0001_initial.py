    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nariad_code', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='prokes.nariad', verbose_name='Код наряда')),
            ],
            options={
                'verbose_name': 'ОТК',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.IntegerField(verbose_name='Количество')),
                ('customer_goods_value', models.IntegerField(default=0, verbose_name='Количество требуемых изделий')),
